    ...
    function reduceChoices(acc, e) {
      ...
      if (foudItem.lastName) {
        // itemStyle += 'background:'+ephHelpers.colorFromLetters(foudItem.name.substring(0,1)+foudItem.lastName.substring(0,1))+';'
          ...
          let style = 'style="background: '+ephHelpers.colorFromLetters(letters)+';width: 23px;height: 23px;border-radius: 100%;padding: 6px;font-size: 10px;color: white;text-align: center;position: absolute;left: -5px;top: -1px;"'
          nestedHtml +=`
