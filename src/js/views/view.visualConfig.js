var createvisualConfigView = function () {
  var self ={};
  ...
  var render = async function () {
    ...
    //add label
    currentGroupedLabels.push('Elements Types')
  ...
  var updateItemsToDisplayAndRelations= async function (elementVisibility) {//only side effect TODO: find a better way?
    ...
    var array1 =store.categories.map(function (e) {
...
var visualConfigView = createvisualConfigView();
visualConfigView.init()
